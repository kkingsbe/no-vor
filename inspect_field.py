...
for f in manager.GetFields(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance):
    if f.Name == "allowInputs":
        print("Field: {}".format(f.Name))
        print("Type: {}".format(f.FieldType.Name))
        print("IsPublic: {}".format(f.IsPublic))
        print("IsPrivate: {}".format(f.IsPrivate))
        print("IsFamily: {}".format(f.IsFamily))
        print("IsAssembly: {}".format(f.IsAssembly))
