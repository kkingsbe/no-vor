...
internal static class Program
{
    ...
    private static void Main()
    {
        ...
        Equal(-90d, NavMath.SteeringDeviationDegrees(0d, 90d), "steer right deviation");
        Equal(90d, NavMath.SteeringDeviationDegrees(0d, 270d), "steer left deviation");
        ...
        Console.WriteLine("NavMathHarness: 12 passed");
    }
